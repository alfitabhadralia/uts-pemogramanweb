  ...
  <body>
    ...
    <img src="diving.png" alt="..." style="width:300%; height:350px; position: relative; z-index: 1;">
        <div class="container">
            ...
            <h6 style="position: absolute; top: 370px; z-index: 2; color: white;">Home / Profil / Laboratorium</h6>
        </div>
      <br><br>

    <!--Content-->
    <div class="container text-justify">
        <p> <br> Guna melengkapi kebutuhan sarana dan prasarana pendukung pembelajaran pada Program Studi Sistem Informasi Kelautan maka akan dikembangkan secara bertahap beberapa laboratorium, diantaranya:

            Laboratorium Ekologi Kelautan
            Laboratorium Komputer
            Laboratorium Kualitas Air
            Selain itu, beberapa fasilitas lainnya yang terdapat pada Program Studi Sistem Informasi Kelautan antara lain:
            
            Ruang Kuliah dengan jaringan
            Internet
            Perpustakaan dengan buku dan jurnal kelautan dan perikanan
            Lapangan.</p>
    </div>
