  ...
  <body>
    ...
    <img src="diving.png" alt="..." style="width:300%; height:350px; position: relative; z-index: 1;">
        <div class="container">
            ...
            <h6 style="position: absolute; top: 370px; z-index: 2; color: white;">Home / Profil / Kurikulum</h6>
        </div>
      <br><br>

    <!--Content-->
    <div class="container text-justify">
        <p><p><h4> Struktur Kurikulum</h4>
            <br> Program Studi Sistem Informasi Sistem Kelautan  merupakan bagian dari Ilmu Kelautan yang fokus pada analisis data kelautan baik numerik maupun spasial untuk kemudian diintegrasikan berbasis sistem informasi yang dikembangkan sebagai dasar pengambilan keputusan. Berdasarkan hal tersebut bidang kajian dari prodi SIK terdiri dari 5 bidang yaitu:
            <br> - Ilmu Kelautan 
            <br> - Ilmu Perikanan
            <br> - Sistem Informasi
            <br> - Sistem Informasi Geografis
            <br> - Penginderaan Jauh Keluatan dan Ilmu Kelautan
            
            <p><br> Jumlah sks yang harus diambil oleh mahasiswa program studi sistem informasi kelautan adalah 146 sks dengan ketentuan:
            <br> - Mata Kuliah Umum (MKU) = 14 SKS
            <br> - Mata Kuliah Praktik Lapangan = 4 SKS
            <br> - Mata Kuliah Khusus Universitas = 2 SKS
            <br> - Mata Kuliah Khusus Fakultas (MKKF) = 6 SKS
            <br> - Mata Kuliah Keahlian Inti Program Studi (MKKIPS) = 102 SKS
            <br> - Mata Kuliah Keahlian Pilihan Program Studi (MKKPPS) = 18 SKS dengan mata kuliah pilihan yang ditawarkan sebanyak 31 SKS
    </div>
